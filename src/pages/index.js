    ...
    <div className='app'>
        ...
        <header>
          ...
          <div className="header-inner">
            <div className="social-links">
              <a href="https://www.linkedin.com/in/sarahprasuhn/" target="_blank" rel="noopener noreferrer"><img
              ...
              <a href="https://sarahpstudio.medium.com/" target="_blank" rel="noopener noreferrer"><img
                className="social-img medium align-bottom" src={medium}
            ...
            <div className="navigation">
              <ul className="nav">
                ...
                <li className="nav-item"><a href="https://sarahpstudio.s3.amazonaws.com/SarahPResume.pdf"
                                            target="_blank" rel="noopener noreferrer">Resumé PDF</a></li>
                <li className="nav-item"><Link to="/resume" target="_blank" rel="noopener noreferrer">Resumé Text</Link>
                </li>
                <li className="nav-item"><a href="https://github.com/sarahp" target="_blank"
                                            rel="noopener noreferrer">Github</a></li>
                <li className="nav-item"><a href="mailto: me@sarahp.studio" target="_blank" rel="noopener noreferrer">Email
                  me</a></li>
        ...
        <main>
          <section className="content display-project">
            ...
            <div className="frontpage-portfolio">
              ...
              <p><a href="https://www.wscuc.org/" target="_blank" rel="noopener noreferrer">WASC</a>. I completely
                redesigned and built the FrontEnd of this site. Using Bootstrap and Drupal 7. I am proud to say that it
                has stood the test of time.</p>
              <a href="https://www.wscuc.org/" target="_blank" rel="noopener noreferrer"><img
                className="portfolio-image" src={wasc}
                alt="Site example a red and white Non-Profit Organization site."></img></a>
              ...
              <a href="https://www.curf.upenn.edu/" target="_blank" rel="noopener noreferrer"><img
                className="portfolio-image" src={upenn} alt="Site example a blue and white university site."></img></a>

              <p><a href="https://www.hunterboots.com/us/en_us/" target="_blank" rel="noopener noreferrer">Hunter
                Boots</a>. In a white label collaboration. I managed the tech team, and built the front end. Like WASC
                this site has stood the test of time. And I'm proud that my work still lives selling my favorite boots.
              </p>
              <a href="https://www.hunterboots.com/us/en_us/" target="_blank" rel="noopener noreferrer"><img
                className="portfolio-image" src={hunter} alt="Site example a white and red retail clothing site."></img></a>
              ...
              <a href="https://www.xepicream.com/" target="_blank" rel="noopener noreferrer"><img
                className="portfolio-image" src={xepi} alt="Site example a purple and white pharmaceutical site."></img></a>
      ...
      <footer>
        <div className="footer-navigation">
          <div className="navigation">
            <ul className="nav ">
              <li className="nav-item"><a href="https://sarahpstudio.s3.amazonaws.com/SarahPResume.pdf" target="_blank"
          ...
          <div className="social-links">
            <a href="https://www.linkedin.com/in/sarahprasuhn/" target="_blank" rel="noopener noreferrer"><img
              ...
              src={linkedin} /></a>
            <a href="https://sarahpstudio.medium.com/" target="_blank" rel="noopener noreferrer"><img
              className="social-img medium align-bottom" src={medium} alt="A large letter M in blue and gray." /></a>
